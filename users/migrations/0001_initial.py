    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Admin'), ('temp_worker', 'Zeitarbeitskraft'), ('project_leader', 'Projektleiter')], max_length=20)),
                ('agency_name', models.CharField(blank=True, max_length=120, null=True)),
